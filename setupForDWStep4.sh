...
#  you do not need to run the curl statement, the file is included in this git project
...
hdfs dfs -mkdir s3a://prod-cdptrialuser27-trycdp-com/cdp-lake/data/cdpvw3/telcochurn
